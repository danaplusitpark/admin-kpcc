...
function AddOrganisation() {
  ...
  const handleSubmit = () => {
    ...
    axios.post(`${SERVER_URL}/admin/add-organizations`, formData, {
      headers: {
        'x-access-token': localStorage.getItem("token")
      }
    }).then((res) => {
  ...
  return (
    <Sidebar>
      <div>
        <h1 className="text-3xl font-bold mx-auto">Add Organisation</h1>
            ...
            <tbody>
              {organizations?.map((item: any) => (
                <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                  ...
                  <td className="px-2 py-1" width={"150px"}><img src={item?.image} /></td>
