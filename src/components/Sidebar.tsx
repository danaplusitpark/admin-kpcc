                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span className="ms-3">Add Bearers</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                            ...
                            >
                                ...
                                <span className="ms-3">All Bearers</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                            ...
                            >
                                ...
                                <span className="ms-3">Add Blogs</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span className="ms-3">Add Organisations</span>
                            </Link>
                        </li>
                        <li>
                        
                            <Link
                                href="/all-organisations"
                                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                            >
                                <svg
                                    className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                ...
                                <span className="ms-3">All Organisations</span>
                            </Link>
                        </li>
